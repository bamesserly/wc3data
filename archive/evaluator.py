...
# from list_of_new_games import list_of_new_games
...
for x in range (0, len(organized_list_of_games)):
    ...
    try:
        ...
        player_dictionary[player1] = [starting_elo, 0]
    try:
        player2_ELO = (player_dictionary[player2][0])
    except:
        player2_ELO = starting_elo
        player_dictionary[player2] = [starting_elo, 0]
...
# print(refined_elo_sorted_player_list)
