...
def main():
  ...
  list_of_games = (sorted(list_of_games, key=lambda x: (x['date_time'][8],x['date_time'][9],x['date_time'][3],x['date_time'][4],x['date_time'][0],x['date_time'][1],x['date_time'][11],x['date_time'][12],x['date_time'][14],x['date_time'][15])))
  ...
  for x in list_of_games:
    ...
    if not player1 in player_dictionaries:
      ...
      print "game_date_time " + game_date_time
      print "most recent game " + player_dictionaries[player1]['most_recent_game_time']
    ...
    if not player2 in player_dictionaries:
      ...
      print "game_date_time " + game_date_time
      print "most recent game " + player_dictionaries[player2]['most_recent_game_time']
