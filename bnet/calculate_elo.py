...
def main():
  ...
  #list_of_elos = open('list_of_elos.txt', 'w+')
  ...
  for x in list_of_games:
    ...
    player_dictionaries[player1]['elo'] = int(temp_player1_elo)
    player_dictionaries[player2]['elo'] = int(temp_player2_elo)
    ...
    player_dictionaries[player1]['winrate'] = round((player_dictionaries[player1]['wins'] / (player_dictionaries[player1]['wins'] + player_dictionaries[player1]['losses']))*100, 2)
    player_dictionaries[player2]['winrate'] = round((player_dictionaries[player2]['wins'] / (player_dictionaries[player2]['wins'] + player_dictionaries[player2]['losses']))*100, 2)
